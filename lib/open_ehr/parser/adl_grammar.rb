...
module ADLGrammar
  ...
  def _nt_arch_identification
    ...
    if s0.last
      r0 = instantiate_node(ArchIdentification,input, i0...index, s0)
  ...
  def _nt_arch_head
    ...
    if s0.last
      r0 = instantiate_node(ArchHead,input, i0...index, s0)
      r0.extend(ArchHead0)
    else
      @index = i0
      r0 = nil
  ...
  def _nt_arch_meta_data
    ...
    if s0.last
      r0 = instantiate_node(ArchMetaData,input, i0...index, s0)
  ...
  def _nt_arch_meta_data_items
    ...
    if s0.last
      r0 = instantiate_node(ArchMetaDataItems,input, i0...index, s0)
  ...
  def _nt_arch_meta_data_item
    ...
    if s1.last
      r1 = instantiate_node(ArchMetaDataItem,input, i1...index, s1)
    ...
    if r1
      ...
      if s6.last
        r6 = instantiate_node(ArchMetaDataItem,input, i6...index, s6)
        r6.extend(ArchMetaDataItem1)
      else
        @index = i6
        r6 = nil
      end
